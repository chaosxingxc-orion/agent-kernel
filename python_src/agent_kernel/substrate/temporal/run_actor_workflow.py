...
_RUN_ACTOR_CONFIG: dict[str, RunActorDependencyBundle | None] = {
    "dependencies": None,
}


def configure_run_actor_dependencies(dependencies: RunActorDependencyBundle | None) -> None:
    """Configures process-local default dependencies for workflow construction."""
    _RUN_ACTOR_CONFIG["dependencies"] = dependencies
...
def _resolve_run_actor_dependencies(
    ...
    configured_dependencies = _RUN_ACTOR_CONFIG["dependencies"]
